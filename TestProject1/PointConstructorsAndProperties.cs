...
namespace OGTests
{
    public class PointConstructorsAndProperties
    {
        ...
        public bool ConstructorDoubleDoubleDoublePositive()
        {
            ...
            return data.comparePointProperties(OGpoint, point);
        }
        ...
        public bool ConstructorPointPositive()
        {
            ...
            return data.comparePointProperties(new OGPoint3d(OGpoint), new Point3d(point));
        }
        ...
        public bool ConstructorVectorPositive()
        {
            ...
            return data.comparePointProperties(new OGPoint3d(OGvec), new Point3d(vec));
        }
